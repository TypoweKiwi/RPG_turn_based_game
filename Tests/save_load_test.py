...
if game1.adventure_hub == game2.adventure_hub:
    ...
    print("Test failed")
    # print("Cleric game1")
    # print(game1.adventure_hub.team._players[0].__dict__)
    # print("\n")
    # print("Cleric game 2")
    # print(game2.adventure_hub.team._players[0].__dict__)
    # print("\n")
    # print("Skill cleric game 1")
    # print(game1.adventure_hub.team._players[0].skills[0].__dict__)
    # print("\n")
    # print("Skill cleric game 2")
    # print(game2.adventure_hub.team._players[0].skills[0].__dict__)